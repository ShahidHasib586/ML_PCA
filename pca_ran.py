# -*- coding: utf-8 -*-
"""
Created on Tue Jun  8 01:13:21 2021
...
for c in df.columns[1:]:
    df.boxplot(c,by='Range_Km',figsize=(14,8),fontsize=14)
    plt.title("{}\n".format(c),fontsize=16)
    plt.xlabel("Vehicle data", fontsize=16)

#plot co-varience matrix (PriceEuro vs Range)
plt.figure(figsize=(20,12))
plt.scatter(df['PriceEuro'],df['Brand_Encoded'],c=df['Range_Km'],edgecolors='pink',alpha=1.5,s=300)
plt.grid(True)
plt.title("Scatter plot of two features showing the \ncorrelation and class seperation",fontsize=15)
plt.xlabel("PriceEuro",fontsize=15)
plt.ylabel("Brand_Encoded'",fontsize=15)
plt.show()
#plot co-varience matrix (Efficiency_WhKm vs Range)
plt.figure(figsize=(20,12))
plt.scatter(df['Efficiency_WhKm'],df['Brand_Encoded'],c=df['Range_Km'],edgecolors='pink',alpha=1.5,s=300)
plt.grid(True)
plt.title("Scatter plot of two features showing the \ncorrelation and class seperation",fontsize=15)
...
plt.figure(figsize=(20,12))
plt.scatter(df['AccelSec'],df['Brand_Encoded'],c=df['Range_Km'],edgecolors='pink',alpha=1.5,s=300)
plt.grid(True)
plt.title("Scatter plot of two features showing the \ncorrelation and class seperation",fontsize=15)
...
plt.figure(figsize=(20,12))
plt.scatter(df['TopSpeed_KmH'],df['Brand_Encoded'],c=df['Range_Km'],edgecolors='pink',alpha=1.5,s=300)
plt.grid(True)
plt.title("Scatter plot of two features showing the \ncorrelation and class seperation",fontsize=15)
...
plt.figure(figsize=(20,12))
plt.scatter(df['Battery_Pack Kwh'],df['Brand_Encoded'],c=df['Range_Km'],edgecolors='pink',alpha=1.5,s=300)
plt.grid(True)
plt.title("Scatter plot of two features showing the \ncorrelation and class seperation",fontsize=15)
...
plt.figure(figsize=(20,12))
plt.scatter(df['FastCharge_KmH'],df['Brand_Encoded'],c=df['Range_Km'],edgecolors='pink',alpha=1.5,s=300)
plt.grid(True)
plt.title("Scatter plot of two features showing the \ncorrelation and class seperation",fontsize=15)
